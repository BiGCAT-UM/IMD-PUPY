...
total_list_diseases <- c(list_diseases_purine, list_diseases_pyrimidine, list_diseases_urea)
...
remove(total_list_diseases, amount_biomarkers_matrixData, amount_biomarkers_mergedData, amount_diseases_matrixData, amount_diseases_purine, amount_diseases_pyrimidine, amount_diseases_urea, column_start, ordered_biomarkerNames, ordered_disorderNames, list_diseases_purine, list_diseases_pyrimidine, list_diseases_urea, not_covered_IMDs, total_amount_diseases)
```
...
```{r}
## This visualization only works for the HTML version online.
knitr::include_graphics("https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/patient_I_network_First.png?raw=true")
```
...
```{r}
knitr::include_graphics("https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/patient_I_network_Second.png?raw=true")
```
