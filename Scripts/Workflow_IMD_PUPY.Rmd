...
knitr::include_graphics("https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/PatientI_network1.png?raw=true")
```
...
```{r}
knitr::include_graphics("https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/PatientI_network2.png?raw=true")
```
