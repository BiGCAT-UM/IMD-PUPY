...
where {
VALUES ?wpid {\'WP4224\' \'WP4225\' \'WP4571\' \'WP4595\' \'WP4583\' \'WP4584\'}
...
WHERE {
VALUES ?wpid_revision {wprdfp:WP4224_r120400 wprdfp:WP4225_r120401 wprdfp:WP4571_r120383 wprdfp:WP4595_r120393}
...
#Dynamix caption for patient specific biomarkers:
...
```{r}
# Make sure to open cytoscape (>=3.9.1)
cytoscapePing ()
...
url <- "https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/BridgeDbApp_location.png"
```
## Some cat!
![](`r url`)

```{r}
opts_knit$set(base.url='https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/BridgeDbApp_location.png')
```

Then, set up your mappings to work with the BridgeDb webservice; click on 'Manage ID Mapping Resources':

```{r}
opts_knit$set(base.url='https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/BridgeDbApp_mappingResource.png')
```

Next, selecting the following settings (and click 'OK'):

```{r}
opts_knit$set(base.url='https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/BridgeDbApp_webserviceSelection.png')
```

Last, select the following settings (example for HMDB mappings):

```{r}
opts_knit$set(base.url='https://github.com/BiGCAT-UM/IMD-PUPY/blob/main/Images/BridgeDbApp_mappingTask.png')
```
