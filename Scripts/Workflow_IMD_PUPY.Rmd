...
##Setting working directory to local github file for Linux (note: you probably need to change the file path, if you run this workflow on a Windows machine):
knitr::opts_chunk$set(echo = TRUE)
#setwd("~/git/IMD")
knitr::opts_knit$set(root.dir = "~/git/IMD")
```
...
rownames(patient_extension) <- patientID
